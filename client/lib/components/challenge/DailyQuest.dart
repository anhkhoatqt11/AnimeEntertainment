...
class _DailyQuestListState extends State<DailyQuestList> {
  ...
  int loginGift = 0;
  final bool hasReceivedDailyGift = false;
        ...
        Consumer(builder: (BuildContext context, value, Widget? child) {
          ...
          return Column(
            children: List.generate(questList.length, (index) {
              return questList[index].questType == "login"
                                          ...
                                          onPressed: () async {
                                            ...
                                            if (!checkHasReceived(
                                              ...
                                              Provider.of<UserProvider>(context,
                                                  ...
                                                  .setReceived(
                                                      questList[index].id);
                                              await DailyQuestsApi
                                                  .updateQuestLog(context,
                                                      questList[index].id!);
                                              showDialog(
                                                  context: context,
                                                  builder: (_) =>
